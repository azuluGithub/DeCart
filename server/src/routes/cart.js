...
/**
 * #GET CART ENDPOINT: 
 * #RETURNS CART WITH PRODUCTS [IS A READ OPERATION]
 * #IN CART, ONLY PRODUCT ID's ARE SAVED INSTEAD OF ACTUAL PRODUCT
 * #THEREFORE TO POPULATE CART YOU NEED TO FIND THE ACTUAL PRODUCT IN PRODUCTs
 */
...
/**
 * #ADD ENDPOINT: 
 * #ADD NEW PRODUCT IN CART [IS A CREATE OPERATION]
...
/**NB: DELETE CHANGED TO POST INTENTIONALY INORDER TO SEND DATA FROM FRONT-END TO BACK-END*/
/**
 * #DELETE CART ENDPOINT: 
 * #DELETES SELECTED PRODUCT FROM CARD [IS A DELETE OPERATION]
 * #SINCE DATA IS NOT STORED, CART IS PASSED FROM FRONT-END TO BACK-END
 ...
 * #PUT ENDPOINT: 
 * #UPDATES CART ITEMS [IS AN UPDATE OPERATION]
 * #FOR CHANGING E.G PRODUCT COLOR, QUANTITY ETC
 */
